...
cross_country_db_app = Blueprint('cross_country_db_app', __name__, template_folder='templates')
...
@cross_country_db_app.route('/getTopCourseResults',methods=['GET'])
...
@cross_country_db_app.route('/getCourseInfo',methods=['GET'])
def getCourseInfo():
    try:
        courseId = request.args.get('courseId', default = 1, type = int)
...
@cross_country_db_app.route('/getTopTeamCourseResults',methods=['GET'])
...
@cross_country_db_app.route('/getXcResultsByRaceCompetitor',methods=['GET'])
...
@cross_country_db_app.route('/getXcRunners',methods=['GET'])
def getXcRunners():
    try:
        genderId = request.args.get('genderId', default = 2, type = int)
...
@cross_country_db_app.route('/getXcRunnerResults',methods=['GET'])
...
@cross_country_db_app.route('/getXcCompetitorsByYear',methods=['GET'])
...
@cross_country_db_app.route('/getXcRacesByYear',methods=['GET'])
...
@cross_country_db_app.route('/getXcCompetitorResults',methods=['GET'])
...
@cross_country_db_app.route('/getXcRaceResults',methods=['GET'])
...
@cross_country_db_app.route('/getPastXcAlumniChampions',methods=['GET'])
